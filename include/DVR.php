...
class DVR {
    ...
    /// @throw exception with given message and response code
    public static function badrequest($message, $responseCode="abuse") {
         http_response_code(400); // Bad Request
        throw new DVRException("bad request. ".$message, $responseCode);
    }
